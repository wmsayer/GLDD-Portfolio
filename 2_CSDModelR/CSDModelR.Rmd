...
# Specific Project Reference Plots


```{r}
proj_list = c(72663, 72561)
project_set_daily = clean_df[clean_df$ProjectNumber %in% proj_list, ]
project_set_sj_avg = get_avgs(project_set_daily)
```
...
```{r include=FALSE}
pred_area = exp(predict(model_2, newdata = project_set_daily))
#pred_area = predict(bad_model, newdata = project_set_daily)

face = project_set_daily$Face

pred_prod = pred_area*face/project_set_daily$WorkHrs/27
act_prod = project_set_daily$Area*face/project_set_daily$WorkHrs/27

pred_covg = pred_area/project_set_daily$WorkHrs
act_covg = project_set_daily$Area/project_set_daily$WorkHrs
```
...
plot(face, pred_prod, xlab = "Face (ft)", ylab = "Production (cy/wh)", col = "red", pch="o", 
     main = "Production vs Face (Daily)", xlim=c(face_min, face_max), ylim=c(prod_min, prod_max))
points(face, act_prod, col="blue", pch="*")
legend(face_min, prod_max, legend=c("Log Model", "Project Data"),
       col=c("red", "blue"), pch = c("o", "*"))
```
...
plot(face, pred_covg, xlab = "Face (ft)", ylab = "Coverage (sqft/wh)", col = "red", 
     main = "Coverage vs Face (Daily)", xlim=c(face_min, face_max), ylim=c(covg_min, covg_max))
points(face, act_covg, col="blue", pch="*")
legend(7.4, covg_max, legend=c("Log Model", "Project Data"),
       col=c("red", "blue"), pch = c("o", "*"))
```
...
```{r include=FALSE}
pred_area = exp(predict(model_2, newdata = project_set_sj_avg))
#pred_area = predict(bad_model, newdata = project_set_sj_avg)

face = project_set_sj_avg$Face

pred_prod = pred_area*face/project_set_sj_avg$WorkHrs/27
act_prod = project_set_sj_avg$Area*face/project_set_sj_avg$WorkHrs/27

pred_covg = pred_area/project_set_sj_avg$WorkHrs
act_covg = project_set_sj_avg$Area/project_set_sj_avg$WorkHrs
```
...
```{r echo=FALSE}
plot(face, pred_prod, xlab = "Face (ft)", ylab = "Production (cy/wh)", col = "red", pch="o", 
     main = "Production vs Face (SJ AVg)", xlim=c(4, 10), ylim=c(0, 4000))
points(face, act_prod, col="blue", pch="*")
legend(face_min, prod_max, legend=c("Log Model", "Test Data (actual)"),
       col=c("red", "blue"), pch = c("o", "*"))
```
...
```{r echo=FALSE}
plot(face, pred_covg, xlab = "Face (ft)", ylab = "Coverage (sqft/wh)", col = "red", 
     main = "Coverage vs Face (SJ Avg)", xlim=c(4, 10), ylim=c(0, 30000))
points(face, act_covg, col="blue", pch="*")
legend(7.4, covg_max, legend=c("Log Model", "Test Data (actual)"),
       col=c("red", "blue"), pch = c("o", "*"))
```
